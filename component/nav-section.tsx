    ...
    <div>
      <div>
        ...
        <p className="mt-4 max-w-xs leading-normal text-muted-foreground">
          I build accessible, robust, and performance-driven digital experiences
          for the web.
        </p>
      ...
      <div className="mt-8 flex items-center gap-5">
        <Link href="https://github.com/secretnacode">
          {/* github */}
          <svg
            className="group [&_path]:stroke-muted-foreground [&_path]:group-hover:stroke-foreground transition-colors  size-7"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <Link
          href="https://www.linkedin.com/in/clark-david-catle/"
          className=""
        >
          {/* linkedin */}
          <svg
            fill="#000000"
            className="fill-muted-foreground hover:fill-foreground transition-colors  size-6"
        ...
        >
          {/* gmail */}
          <svg
            className="group [&_path,rect]:stroke-muted-foreground [&_path,rect]:group-hover:stroke-foreground transition-colors size-8 grid place-items-end"
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
